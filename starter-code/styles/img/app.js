...
// DONE: Uncomment the following line of code to see the output in the browser console
console.log('ADDED THIS', sum(1, 2, 3, 4));
...
// DONE: Uncomment the following line of code to see the output in the browser console
console.log(`ADDED THIS`, objectLit([`yup`, `fine`, `okay`]));

const sumAndProduct = (a, b) => `${a} + ${b} = ${a + b}`;


// DONE: Uncomment the following line of code to see the output in the browser console
console.log(`ADDED THIS`, sumAndProduct(3, 9));
...
// DONE: Uncomment the following line of code to see the output in the browser console
 console.log(`ADDED THIS`, message('Allie'));
...
console.log(`ADDED THIS`, joe.greeting());
...
console.log(`ADDED THIS`, Student.courseName());
...
// DONE: Uncomment the following line of code to see the output in the browser console
console.log(`Window is being produced`, joe.scopeArrow());

// TODO: Write a COMMENT below to answer the following questions.
// 1. What is "this" when joe.scope() is invoked?
//  "this" is refrencing up the code to when joe was first defined. Though still undifined. 
// 2. What is "this" when joe.scopeArrow() is invoked?
// This this" is referencing only the single instance of "this" within the same line of code. Which 
// makes it undefined as well as a completly open console.log().
// 3. Explain why "this" is different when an arrow function is used.
//  I am unsure, but I do know that when the arrow function is used in this instance it provides a phonebook of info without any relevent data. "Window" is what is being produced.